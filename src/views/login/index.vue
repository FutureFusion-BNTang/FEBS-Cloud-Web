  ...
  <div id="loginLayout">
    <div class="login_page">
      ...
      <div class="login_page_foot">
        <div class="copyright">&copy; {{ curYear }} <a target="_blank" href="https://mrbird.cc">MrBird</a> - FEBS <a target="_blank" href="https://beian.miit.gov.cn/">闽ICP备19019240号-1</a></div>
      </div>
    </div>
  </div>
</template>
